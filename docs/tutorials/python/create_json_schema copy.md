...
In this tutorial, you will learn how to create theses JSON Schema using an existing data-model
...
```python
{!docs/tutorials/python/tutorial_scripts/create_json_schema.py!lines=6-8}
```
...
```python
{!docs/tutorials/python/tutorial_scripts/json_schema.py!lines=10-16}
```
