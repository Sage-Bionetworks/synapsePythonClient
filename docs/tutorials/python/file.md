...
!!! warning "Uploading Large Files"
    If you are uploading very large files (>100 GB each), consider using the **async OOP API with sequential uploads** for better performance and resource management.
