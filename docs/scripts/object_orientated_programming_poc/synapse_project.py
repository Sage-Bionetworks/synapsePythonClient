...
# Read me about the OpenTelemetry setup in the README file. This is optional and may
...
with tracer.start_as_current_span("Storing several folders to a project"):
    for loop in range(1, 10):
...
with tracer.start_as_current_span("Using synapseutils to sync a project"):
