"""Integration tests for the synapseclient.operations.store_async function."""
...
class TestFactoryOperationsStoreAsync:
    """Tests for the synapseclient.operations.store_async function."""
    ...
    async def test_store_async_project_basic(self) -> None:
        ...
        # WHEN I store the project using store_async
        stored_project = await store_async(project, synapse_client=self.syn)
        ...
        # WHEN I delete the project using delete_async
        await delete_async(stored_project, synapse_client=self.syn)
    ...
    async def test_store_async_project_with_container_options(self) -> None:
        ...
        stored_project = await store_async(
            project,
    ...
    async def test_store_async_folder_basic(self, project_model: Project) -> None:
        ...
        # WHEN I store the folder using store_async
        stored_folder = await store_async(folder, synapse_client=self.syn)
        ...
        # WHEN I delete the folder using delete_async
        await delete_async(stored_folder, synapse_client=self.syn)

        # THEN the folder should no longer be retrievable
        with pytest.raises(Exception):
            await Folder(id=stored_folder.id).get_async(synapse_client=self.syn)

    async def test_store_async_folder_with_parent_param(
        ...
        stored_folder = await store_async(
            folder, parent=project_model, synapse_client=self.syn
        )
        self.schedule_for_cleanup(stored_folder.id)
    ...
    async def test_store_async_file_basic(self, project_model: Project) -> None:
        """Test storing a File entity."""
        # GIVEN a new file
        file = self.create_file_instance()
        file.parent_id = project_model.id

        # WHEN I store the file using store_async
        stored_file = await store_async(file, synapse_client=self.syn)
        ...
        # WHEN I delete the file using delete_async
        await delete_async(stored_file, synapse_client=self.syn)

        # THEN the file should no longer be retrievable (would raise 404)
        with pytest.raises(Exception):
            await File(id=stored_file.id).get_async(synapse_client=self.syn)

    async def test_store_and_delete_async_file_by_id_string(
        self, project_model: Project
    ) -> None:
        ...
        await delete_async(stored_file.id, synapse_client=self.syn)

        # THEN the file should no longer be retrievable
        with pytest.raises(Exception):
            await File(id=stored_file.id).get_async(synapse_client=self.syn)

    async def test_store_async_file_with_file_options(
        self, project_model: Project
    ) -> None:
        ...
        stored_file = await store_async(
            file, file_options=file_options, synapse_client=self.syn
        )
        self.schedule_for_cleanup(stored_file.id)
    ...
    async def test_store_async_file_update(self, project_model: Project) -> None:
        ...
        updated_file = await store_async(stored_file, synapse_client=self.syn)
    ...
    async def test_store_async_recordset_basic(self, project_model: Project) -> None:
        ...
        # WHEN I store the recordset using store_async
        stored_recordset = await store_async(recordset, synapse_client=self.syn)
    ...
    async def test_store_async_link_basic(self, project_model: Project) -> None:
        ...
        # WHEN I store the link using store_async
        stored_link = await store_async(link, synapse_client=self.syn)
    ...
    async def test_store_async_table_basic(self, project_model: Project) -> None:
        ...
        # WHEN I store the table using store_async
        stored_table = await store_async(table, synapse_client=self.syn)
        ...
        # WHEN I delete the table using delete_async
        await delete_async(stored_table, synapse_client=self.syn)

        # THEN the table should no longer be retrievable
        with pytest.raises(Exception):
            await Table(id=stored_table.id).get_async(synapse_client=self.syn)

    async def test_store_async_table_with_table_options(
        self, project_model: Project
    ) -> None:
    ...
    async def test_store_async_dataset_basic(self, project_model: Project) -> None:
        ...
        # WHEN I store the dataset using store_async
        stored_dataset = await store_async(dataset, synapse_client=self.syn)
        ...
        # WHEN I delete the dataset using delete_async
        await delete_async(stored_dataset, synapse_client=self.syn)

        # THEN the dataset should no longer be retrievable
        with pytest.raises(Exception):
            await Dataset(id=stored_dataset.id).get_async(synapse_client=self.syn)
    ...
    async def test_store_async_entity_view_basic(self, project_model: Project) -> None:
        ...
        # WHEN I store the entity view using store_async
        stored_view = await store_async(entity_view, synapse_client=self.syn)
    ...
    async def test_store_async_submission_view_basic(
        self, project_model: Project
    ) -> None:
        ...
        # WHEN I store the submission view using store_async
        stored_view = await store_async(submission_view, synapse_client=self.syn)
        self.schedule_for_cleanup(stored_view.id)
    ...
    async def test_store_async_materialized_view_basic(
        self, project_model: Project
    ) -> None:
        ...
        stored_source = await store_async(source_table, synapse_client=self.syn)
        ...
        # WHEN I store the materialized view using store_async
        stored_view = await store_async(materialized_view, synapse_client=self.syn)
        self.schedule_for_cleanup(stored_view.id)
    ...
    async def test_store_async_virtual_table_basic(
        self, project_model: Project
    ) -> None:
        ...
        # WHEN I store the virtual table using store_async
        stored_virtual = await store_async(virtual_table, synapse_client=self.syn)
    ...
    async def test_store_async_evaluation_basic(self, project_model: Project) -> None:
        ...
        # WHEN I store the evaluation using store_async
        stored_evaluation = await store_async(evaluation, synapse_client=self.syn)
    ...
    async def test_store_async_team_basic(self) -> None:
        ...
        # WHEN I store the team using store_async
        stored_team = await store_async(team, synapse_client=self.syn)
        ...
        # WHEN I delete the team using delete_async
        await delete_async(stored_team, synapse_client=self.syn)

        # THEN the team should no longer be retrievable
        with pytest.raises(Exception):
            await Team(id=stored_team.id).get_async(synapse_client=self.syn)

    async def test_store_async_curation_task_basic(
        self, project_model: Project
    ) -> None:
        ...
        # WHEN I store the curation task using store_async
        stored_task = await store_async(curation_task, synapse_client=self.syn)
    ...
    async def test_store_async_schema_organization_basic(self) -> None:
        ...
        # WHEN I store the schema organization using store_async
        ...
        # WHEN I delete the schema organization using delete_async
        await delete_async(stored_org, synapse_client=self.syn)
    ...
    async def test_store_async_unsupported_entity_raises_error(self) -> None:
        ...
        with pytest.raises(ValueError, match="Unsupported entity type"):
            await store_async(invalid_entity, synapse_client=self.syn)

    async def test_store_async_file_with_activity(self, project_model: Project) -> None:
    ...
    async def test_store_async_table_dry_run(self, project_model: Project) -> None:
    ...
    async def test_store_async_container_with_raise_exception_strategy(
        self, project_model: Project
    ) -> None:
    ...
    async def test_store_async_form_group_basic(self, project_model: Project) -> None:
        ...
        # WHEN I store the form group using store_async
        stored_form_group = await store_async(form_group, synapse_client=self.syn)

        # THEN the form group is created
        assert stored_form_group.group_id is not None
        assert stored_form_group.name == form_group.name

    async def test_store_async_form_data_basic(self, project_model: Project) -> None:
        ...
        # WHEN I store the form data using store_async
        stored_form_data = await store_async(form_data, synapse_client=self.syn)
    ...
    async def test_store_async_json_schema_basic(self) -> None:
        ...
        # WHEN I store the JSON schema using store_async
        stored_schema = await store_async(
            json_schema,
        ...
        # WHEN I delete the JSON schema using delete_async
        await delete_async(stored_schema, synapse_client=self.syn)
    ...
    async def test_store_async_grid_basic(self, project_model: Project) -> None:
        ...
        # WHEN I store the grid using store_async
        stored_grid = await store_async(
            grid,
        ...
        # WHEN I delete the grid using delete_async
        await delete_async(stored_grid, synapse_client=self.syn)
