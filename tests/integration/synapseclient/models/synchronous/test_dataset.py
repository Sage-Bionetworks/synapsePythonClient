...
def test_create_dataset_with_files(syn, project, test_files: List[str]) -> None:
    """Test creating a dataset with one or more files"""
    pass


def test_create_dataset_with_folders(syn, project, test_folders: List[str]) -> None:
...
def test_update_dataset_columns(syn, project, dataset: Dataset) -> None:
    """Test adding and removing columns from an existing dataset"""
    pass


def test_update_dataset_attributes(syn, project, dataset: Dataset) -> None:
    """Test updating dataset attributes like name, description, annotations"""
    pass


def test_update_dataset_add_files_folders(
...
def test_update_dataset_upsert_rows(
...
def test_update_dataset_remove_rows(
...
def test_delete_dataset(syn, project, dataset: Dataset) -> None:
    """Test deleting an entire dataset"""
    pass


def test_reorder_dataset_columns(
...
def test_rename_dataset_columns(
...
def test_delete_dataset_columns(
...
def test_query_dataset(syn, project, dataset: Dataset, query: str) -> pd.DataFrame:
