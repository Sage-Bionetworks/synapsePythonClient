...
class TestProjectWalk:
    ...
    async def test_walk_recursive_true(self) -> None:
    ...
    async def test_walk_recursive_false(self) -> None:
        ...
        results = list(project_model.walk(recursive=False))
