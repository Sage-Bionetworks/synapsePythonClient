...
class TestEvaluationCreation:
    ...
    async def test_create_evaluation(self):
        ...
        assert created_evaluation.name == "test_evaluation"
        assert created_evaluation.description == "A test evaluation for testing purposes"
...
class TestGetEvaluation:
    ...
    async def test_project(
        ...
        project = await Project(
            id=Project(name=f"test_project_{uuid.uuid4()}").store().id
    ...
    async def test_get_evaluation_by_id(self, test_evaluation: Evaluation, test_project: Project):
    ...
    async def test_get_evaluation_by_name(self, test_evaluation: Evaluation, test_project: Project):
...
class TestEvaluationAccess:
    ...
    async def test_get_evaluation_permissions(self, test_evaluation: Evaluation):
        ...
        permissions = await test_evaluation.get_permissions_async(synapse_client=self.syn)
    ...
    async def test_get_evaluation_permissions_for_specific_user(self, test_evaluation: Evaluation):
        ...
        permissions = await test_evaluation.get_permissions_async(
            principal_id=None,  # This will use the current user
            synapse_client=self.syn
        )
...
class TestEvaluationValidation:
    ...
    async def test_get_evaluation_missing_id_and_name(self):
        ...
        # THEN it should raise a ValueError
        with pytest.raises(ValueError, match="Either id or name must be set to get an evaluation"):
    ...
    async def test_get_permissions_missing_id(self):
        ...
        # THEN it should raise a ValueError
        with pytest.raises(ValueError, match="id must be set to get evaluation permissions"):
