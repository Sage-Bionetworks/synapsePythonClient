...
class TestCachedSessionsMostRecentUserFile():
    ...
    def test_set_most_recent_user(self):
        with patch.object(cached_sessions, "_write_session_cache") as mocked_write_session_cache:
            ...
            mocked_write_session_cache.assert_called_once_with(cached_sessions.SESSION_CACHE_FILEPATH, {"<mostRecent>":"asdf"})
...
class TestMigrateOldSessionFile(object):
    def setup(self):
        ...
        self.patchers = [read_session_cache_patcher, set_most_recent_user_patcher, set_api_key_patcher, os_patcher, equals_path_patcher]
