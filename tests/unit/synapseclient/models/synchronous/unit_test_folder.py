...
class TestFolder:
    ...
    def test_store_with_id(self) -> None:
        ...
        with patch(
            ...
            result = folder.store(synapse_client=self.syn)
    ...
    def test_store_after_get(self) -> None:
        ...
        with patch(
            ...
            folder.get(synapse_client=self.syn)
    ...
    def test_store_with_name_and_parent_id(self) -> None:
        ...
        with patch(
            ...
            # THEN we should call the method with this data
            mocked_client_call.assert_called_once()
            assert mocked_client_call.call_args.kwargs["entity_id"] == SYN_123
            assert mocked_client_call.call_args.kwargs["new_version"] is False
            assert mocked_client_call.call_args.kwargs["synapse_client"] is None
            request_dict = mocked_client_call.call_args.kwargs["request"]
            assert request_dict["id"] == SYN_123
            assert request_dict["name"] == FOLDER_NAME
            assert request_dict["parentId"] == PARENT_ID
            assert request_dict["description"] == description
            assert request_dict["concreteType"] == concrete_types.FOLDER_ENTITY
    ...
    def test_store_with_name_and_parent(self) -> None:
        ...
        with patch(
            ...
            result = folder.store(parent=Folder(id=PARENT_ID), synapse_client=self.syn)
    ...
    def test_get_by_id(self) -> None:
        ...
        with patch(
            ...
            result = folder.get(synapse_client=self.syn)
    ...
    def test_delete_with_id(self) -> None:
        ...
        with patch.object(
            ...
            folder.delete(synapse_client=self.syn)
    ...
    def test_copy(self) -> None:
        ...
        with patch(
            ...
            result = folder.copy(parent_id="destination_id", synapse_client=self.syn)
    ...
    def test_copy_missing_id(self) -> None:
        ...
        # WHEN I call `copy` with the Folder object
        with pytest.raises(ValueError) as e:
            folder.copy(parent_id="destination_id", synapse_client=self.syn)
    ...
    def test_copy_missing_destination(self) -> None:
        ...
        # WHEN I call `copy` with the Folder object
        with pytest.raises(ValueError) as e:
            folder.copy(parent_id=None, synapse_client=self.syn)
    ...
    def test_sync_from_synapse(self) -> None:
        ...
        with patch(
            ...
            result = folder.sync_from_synapse(synapse_client=self.syn)
