...
class TestCreateS3StorageLocation:
    ...
    def _create_storage_location_test(
        ...
        with (
            ...
            patch.object(self.syn, "store_async") as syn_store,
        ):
...
def test_get_submission_with_annotations(syn: Synapse) -> None:
    ...
    with (
        ...
        patch.object(syn, "_getWithEntityBundle_async") as get_entity,
    ):
...
def test_get_submission_and_submission_status_interchangeability(
    ...
    with (
        patch.object(syn, "restGET") as restGET,
        patch.object(Submission, "getURI") as get_submission_uri,
        patch.object(SubmissionStatus, "getURI") as get_status_uri,
        patch.object(syn, "_getWithEntityBundle_async"),
    ):
