...
class TestDownloadList():
    ...
    def setup(self):
        self.manifest = tempfile.NamedTemporaryFile()
        ...
        self.patch_get = self.patch_get.start()
        self.patch_remove_dl_list = patch.object(self.syn, 'remove_from_download_list')
        self.patch_remove_dl_list = self.patch_remove_dl_list.start()
    ...
    def test_get_download_list(self, syn):
        ...
        syn.get_download_list()
        self.patch_get_dl_manifest.assert_called_once()
        self.patch_remove_dl_list.assert_called_once_with(
