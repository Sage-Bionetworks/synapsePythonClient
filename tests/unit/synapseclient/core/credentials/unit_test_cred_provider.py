...
class TestSynapseApiKeyCredentialsProviderChain(object):
    ...
    def test_get_credentials__provider_return_credentials(self):
        ...
        self.cred_provider.get_synapse_credentials.return_value = (
            SynapseApiKeyCredentials(api_key, username)
        )
...
class TestSynapseCredentialProvider(object):
    ...
    def test_create_synapse_credential__username_not_None__auth_token_is_not_None_api_key_not_None(
        self, mocker
    ):
...
class TestCachedCredentialsProvider(object):
    ...
    def setup(self):
        ...
        self.expected_return_tuple = (self.username, api_key, auth_token)

        self.get_most_recent_user__patcher = patch.object(
            cached_sessions, "get_most_recent_user", return_value=self.username
        )
        ...
        self.mock_api_key_credentials.get_from_keyring.return_value = (
            api_key_credentials
        )
        ...
        self.mock_auth_token_credentials.get_from_keyring.return_value = (
