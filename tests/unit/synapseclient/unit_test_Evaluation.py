...
def test_SubmissionStatus_json():
    ...
    expected_status = {
        ...
        "submissionAnnotations": {
            "annotations": {"foo": {"type": "STRING", "value": ["baz"]}},
            "etag": "bar",
            "id": "foo",
        },
    }
    expected_str = json.dumps(
        expected_status, sort_keys=True, indent=2, ensure_ascii=True
    )
