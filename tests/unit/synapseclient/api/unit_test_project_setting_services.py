"""Unit tests for project_setting_services utility functions."""

from unittest.mock import AsyncMock, patch

import pytest

import synapseclient.api.project_setting_services as project_setting_services
...
class TestGetProjectSetting:
    ...
    async def test_get_project_setting_exists(self, mock_synapse):
        ...
        result = await project_setting_services.get_project_setting(
            project_id="syn456",
            setting_type="upload",
            synapse_client=None,
        )
...
class TestCreateProjectSetting:
    ...
    async def test_create_project_setting(self, mock_synapse):
        ...
        result = await project_setting_services.create_project_setting(
            request=body,
            synapse_client=None,
        )
...
class TestUpdateProjectSetting:
    ...
    async def test_update_project_setting(self, mock_synapse):
        ...
        result = await project_setting_services.update_project_setting(
            request=body,
            synapse_client=None,
        )
...
class TestDeleteProjectSetting:
    ...
    async def test_delete_project_setting(self, mock_synapse):
        ...
        await project_setting_services.delete_project_setting(
