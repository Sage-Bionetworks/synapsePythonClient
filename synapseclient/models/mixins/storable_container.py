...
class StorableContainer(StorableContainerSynchronousProtocol):
    ...
    async def generate_sync_manifest_async(
        ...
        *,
        ...
        folder store_async call fails, the exception propagates and no
        manifest is written; any folders already created remain in Synapse
        and will be reused on a retry.
