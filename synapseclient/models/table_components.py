...
class Query:
    ...
    """TODO: create QueryFilter dataclass"""

    selected_facets: Optional[List[Dict[str, Any]]] = None
    """The selected facet filters"""
    """TODO: create AddFacetColumnRequest dataclass"""

    include_entity_etag: Optional[bool] = None
