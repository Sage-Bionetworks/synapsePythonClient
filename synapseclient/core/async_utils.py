...
def otel_trace_function(function_to_trace_name: Union[Callable[..., str], None] = None):
    """
    ...
    def decorator(func):
        ...
        async def otel_trace_method_wrapper(*arg, **kwargs) -> None:
            """Wrapper for the function to be traced."""
            trace_name = (
                function_to_trace_name(*arg, **kwargs)
                if function_to_trace_name
                else None
            )
