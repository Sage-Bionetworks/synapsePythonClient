...
class SynapseAuthTokenCredentials(SynapseCredentials):
    ...
    def __init__(self, token, username=None, displayname=None):
    ...
    def __repr__(self):
        return f"SynapseAuthTokenCredentials(username='{self.username}', displayname='{self.displayname}', token='{self.secret}')"
