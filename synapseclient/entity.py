...
class File(Entity, Versionable):
    ...
    _local_keys = Entity._local_keys + ['path', 'cacheDir', 'files', 'synapseStore', 'externalURL', 'md5', 'fileSize', 'contentType', 'uploadDestination']
...
class Locationable(Versionable):
    ...
    _local_keys = Entity._local_keys + ['cacheDir', 'files', 'path', 'uploadDestination']
