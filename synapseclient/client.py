...
class Synapse:
    ...
    def __getFromFile(self, filepath, limitSearch=None):
        ...
        if len(results)==0: #None found 
            ...
            warning = '\nWARNING: This file is associated with many entities.  You can limit to a specific project or folder by setting the limitSearch to a synapse Id.  Will use the first one returned %s version %i' %( results[0]['id'], results[0]['versionNumber'])
